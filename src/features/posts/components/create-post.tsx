    ...
    <>
      <div className="fixed top-0 left-0 z-10 flex h-screen w-screen flex-col items-center justify-center">
        <div className="border-foreground w-70 rounded-lg border bg-black p-3 text-neutral-100 [@media(min-width:400px)]:w-100">
          <div className="border-foreground flex items-center justify-between border-b pb-1">
              ...
              return (
                <div className="inline-flex w-full flex-col gap-2">
                  ...
                  <Textarea
                    ...
                    className="no-scrollbar border-foreground h-20 w-64 rounded-xl border bg-neutral-950 p-1 px-2 text-sm [@media(min-width:400px)]:w-94"
                  />
                  <div>
                    <SelectThread
                      label="Select Thread"
                      ...
                      className="border-foreground w-64 rounded-xl border bg-neutral-950 p-1 px-2 text-sm [@media(min-width:400px)]:w-94"
                  ...
                  <div className="w-full rounded-lg border border-red-700 bg-red-400/20 p-1.5 px-2 text-sm text-red-500">
                    ⚠️ Test website — do not upload important data.
                  </div>
                </div>
              )
            }}
